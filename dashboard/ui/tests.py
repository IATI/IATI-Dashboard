...
class BasicPageTests(TestCase):
    ...
    def test_headlines(self):
        ...
        self.assertEqual(self.client.get(reverse("dash-headlines-publisher-detail", args=("not-a-valid-publisher", ))).status_code, 404)
    ...
    def test_dataquality(self):
        ...
        self.assertEqual(self.client.get(reverse("dash-dataquality-licenses-detail", args=("cc-by", ))).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-dataquality-licenses-detail", args=("not-a-valid-license", ))).status_code, 404)
    ...
    def test_publishingstats_comprehensiveness(self):
        ...
        self.assertEqual(self.client.get(reverse("dash-publishingstats-comprehensiveness-financials")).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-publishingstats-comprehensiveness-valueadded")).status_code, 200)
    ...
    def test_exploringdata(self):
        ...
        self.assertEqual(self.client.get(reverse("dash-exploringdata-codelists-detail", args=("2", "budget_@type", ))).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-codelists-detail", args=("2", "not-a-valid-slug", ))).status_code, 404)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-codelists-detail", args=("3", "budget_@type", ))).status_code, 404)
        ...
        self.assertEqual(self.client.get(reverse("dash-exploringdata-elements-detail", args=("iati-activity_activity-date_narrative", ))).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-elements-detail", args=("not-a-valid-element", ))).status_code, 404)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-orgids")).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-orgtypes-detail", args=("funding_org", ))).status_code, 200)
        self.assertEqual(self.client.get(reverse("dash-exploringdata-orgtypes-detail", args=("not-a-valid-org-type", ))).status_code, 404)
...
class OriginalDashboardRedirectTests(TestCase):
    ...
    def test_slug_page_redirects(self):
        ...
        self.assertRedirects(self.client.get(r"/publisher/undp.html"),
                             reverse("dash-headlines-publishers"),
                             status_code=301)
        self.assertRedirects(self.client.get(r"/license/cc-by.html"),
                             reverse("dash-dataquality-licenses"),
                             status_code=301)
        self.assertRedirects(self.client.get(r"/codelist/2/budget_@type.html"),
                             reverse("dash-exploringdata-codelists"),
                             status_code=301)
        self.assertRedirects(self.client.get(r"/element/iati-activity_activity-date_narrative.html"),
                             reverse("dash-exploringdata-elements"),
                             status_code=301)
        self.assertRedirects(self.client.get(r"/org_type/funding_org.html"),
                             reverse("dash-exploringdata-orgids"),
                             status_code=301)
