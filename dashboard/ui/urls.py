...
urlpatterns = [
    ...
    path("timeliness_timelag.html", RedirectView.as_view(pattern_name="dash-publishingstats-timeliness-timelag", permanent=True)),
    path("forwardlooking.html", RedirectView.as_view(pattern_name="dash-publishingstats-forwardlooking", permanent=True)),
    path("comprehensiveness.html", RedirectView.as_view(pattern_name="dash-publishingstats-comprehensiveness", permanent=True)),
    path("comprehensiveness_core.html", RedirectView.as_view(pattern_name="dash-publishingstats-comprehensiveness-core", permanent=True)),
    path("comprehensiveness_financials.html", RedirectView.as_view(pattern_name="dash-publishingstats-comprehensiveness-financials", permanent=True)),
    path("comprehensiveness_valueadded.html", RedirectView.as_view(pattern_name="dash-publishingstats-comprehensiveness-valueadded", permanent=True)),
    ...
    re_path(r"codelist\/\d\/\S*.html", RedirectView.as_view(pattern_name="dash-exploringdata-codelists", permanent=True)),
