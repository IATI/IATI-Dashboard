...
page_leads = {
    ...
    'data_quality': 'What is currently broken in the IATI data?',
    ...
    'versions': 'What <a href="http://iatistandard.org/upgrades/all-versions/">versions of the IATI Standard</a> are being used?',
    'rulesets': 'How does IATI data test against rulesets?',
    'licenses': 'What licences are used by IATI publishers?',
