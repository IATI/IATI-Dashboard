...
gitaggregate_publisher = data.JSONDir('./stats-calculated/gitaggregate-publisher')
...
print("All data")
git_stats = AugmentedJSONDir('./stats-calculated/gitaggregate')
make_plot('activities', git_stats)
...
git_stats_publishers = AugmentedJSONDir('./stats-calculated/gitaggregate-publisher/')
