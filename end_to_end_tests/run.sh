...
# Set up data
cp -r end_to_end_tests/fixtures/data IATI-Stats/
cd IATI-Stats/data
git init
git add .
...
cp -r end_to_end_tests/fixtures/ckan IATI-Stats/helpers

rm -r data/ckan_publishers || true
cp -r end_to_end_tests/fixtures/ckan_publishers data/
