...
urlpatterns = (
    [
        ...
        path("errors/download-errors.csv", views.errors_download_csv, name="dash-errors-download-csv"),
        ...
        path("ati/publishers", views.gherkin_publishers, name="dash-ati-publishers"),
        path(
            "ati/publishers/<slug:publisher>",
            views.gherkin_publisher_detail,
